...
export default function LayoutType() {
  return (
    <ul className="gridtype__list"  >
      <NavLink to="/home/grid" activeClassName='active-grid'>
        <li className="gridtype__list--item cursor grid">
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="far"
      ...
      <NavLink to="/home/row" activeClassName='active-grid'>
        <li className="gridtype__list--item row-type" >
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="far"
